            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="jumbotron">
                        ...
                        <font size=15 face="Myriad Pro" color = "#000000">
                       
                       
                            <h3 class ="display-8 text-center"> 
                        Fernando Nateras 
                        Correo: fnaterasb1@gmail.com
                        </h3>  
                        <h3 class ="display-8 text-center"> 
                        Rafael Perez 
                        Correo: tinoco21.30@gmail.com
                        </h3> 
                        <h3 class ="display-8 text-center"> 
                        Karina Enriquez 
                        Correo: karienriquezguillen@gmail.com
                        </h3>  
                         <h3 class ="display-8 text-center"> 
                        Monserrat Alvarez 
                        Correo: esperanzaalvarez120@gmail.com
                        </h3> 
                           <h3 class ="display-8 text-center"> 
                        Lilia Salazar 
                        Correo: liliasalazarherrera@gmail.com
                        </h3> 
                             </font>
                    </div>
                </div>
