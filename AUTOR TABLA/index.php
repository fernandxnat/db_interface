    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="frmnuevo">
              ...
              <input type="text" class="form-control input-sm" id="apellido1" name="apellido1">
              <label>Apellido 2</label>
              <input type="text" class="form-control input-sm" id="apellido2" name="apellido2">
          </form>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmnuevoU">
              ...
              <label>Apellido 1</label>
              <input type="text" class="form-control input-sm" id="apellido1U" name="apellido1U">
              <label>Apellido 2</label>
              <input type="text" class="form-control input-sm" id="apellido2U" name="apellido2U">
    ...
    function agregaFrmActualizar(IDU){
        $.ajax({
            ...
            success: function(data){
                ...
                $('#IDU').val(datos['id_autor']);
                $('#nombreU').val(datos['nombre']);
                $('#apellido1U').val(datos['apellido_1']);
                $('#apellido2U').val(datos['apellido_2']);
            }
