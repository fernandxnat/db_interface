    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="frmnuevo">
              ...
              <input type="text" class="form-control input-sm" id="ap1" name="ap1">
              <label>Apellido 2</label>
              <input type="text" class="form-control input-sm" id="ap2" name="ap2">
              <label>Tipo</label>
              <input type="text" class="form-control input-sm" id="tipo" name="tipo">
              <label>ID tipo de donante</label>
              <input type="text" class="form-control input-sm" id="idtip" name="idtip">
          </form>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmnuevoU">
              ...
              <label>Apellido 1</label>
              <input type="text" class="form-control input-sm" id="ap1U" name="ap1U">
              <label>Apellido 2</label>
              <input type="text" class="form-control input-sm" id="ap2U" name="ap2U">
              <label>Tipo</label>
              <input type="text" class="form-control input-sm" id="tipoU" name="tipoU">
              <label>ID tipo de donante</label>
              <input type="text" class="form-control input-sm" id="idtipU" name="idtipU">
          </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    function agregaFrmActualizar(IDU){
        $.ajax({
            ...
            success: function(data){
                ...
                $('#IDU').val(datos['id_donante']);
                $('#nombreU').val(datos['nombre_donante']);
                $('#ap1U').val(datos['apellido_1']);
                $('#ap2U').val(datos['apellido_2']);
                $('#tipoU').val(datos['tipo']);
                $('#idtipU').val(datos['id_tipo_donante']);
            }
